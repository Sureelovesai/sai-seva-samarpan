        ...
        <div className="grid gap-10 md:grid-cols-2">
          <div>
            ...
            <select
              ...
              className="mt-4 w-full border border-zinc-700 bg-white px-4 py-3 text-base text-gray-900 sm:max-w-[360px] sm:px-6 sm:py-4 sm:text-lg"
            >
        ...
        <div className="mt-10 grid min-w-0 grid-cols-1 gap-10 md:grid-cols-2">
          <div className="min-w-0">
            ...
            <input
              ...
              className="admin-date-input mt-4 w-full border border-zinc-700 bg-white px-4 py-3 text-base text-gray-900 sm:max-w-[360px] sm:px-6 sm:py-4 sm:text-lg"
            />
          </div>
